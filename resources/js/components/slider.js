                ...
                return (
                    this.__values.reduce(
                        (closestIndex, thumbValue, thumbIndex) => {
                            ...
                            if (index !== undefined && thumbIndex === index)
                                return closestIndex
            ...
            Alpine.bind(this.$el, {
                ...
                '@keydown.left'() {
                    ...
                    const newValue = Math.max(
                        this.min,
                        this.__value - this.step,
                    )
                    const closestThumbValue =
                        this.__values[
                            this.__getClosestThumbIndex(
                                this.__value,
                                this.__index,
                            )
                        ]
