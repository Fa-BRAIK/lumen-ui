<template x-teleport="body">
    <ul
        ...
        <template x-for="(toast, index) in toasts" :key="toast.id">
            ...
            >
                    <span
                        class="relative flex flex-col items-start shadow-sm w-full transition-all duration-300 ease-out bg-popover border border-border sm:rounded-md sm:max-w-xs group"
                    ...
                    >
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    :class="{
                                        ...
                                        'text-popover-foreground' : toast.type=='default'
                                    }"
                                >
                                    ...
                                    <p class="text-[13px] font-medium leading-none text-popover-foreground" x-text="toast.message"></p>
                                </div>
                        ...
                        <span
                            ...
                            class="absolute right-0 p-1.5 mr-2.5 text-popover-foreground duration-100 ease-in-out rounded-full opacity-0 cursor-pointer"
