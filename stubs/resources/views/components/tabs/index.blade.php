    ...
    document.addEventListener(typeof Alpine === 'undefined' ? 'alpine:init' : 'livewire:navigated', () => {
        ...
        const handleTrigger = (el, Alpine, {value}) => {
            Alpine.bind(el, () => ({
                ...
                '@focus'() {
                    if (! this.isSelected && ! this.disabled && this.isAutomaticActivation) {
                        this.__onValueChange(this.value);
                    }
                },
                'x-data'() {
        ...
        Alpine.directive('tab', (el, {value, expression}, {Alpine, evaluate}) => {
