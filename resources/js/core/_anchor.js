...
export default function (Alpine) {
    ...
    Alpine.directive('anchorplus', Alpine.skipDuringClone((el, { expression }, { cleanup, evaluate }) => {
        ...
        const compute = () => {
            ...
            const offsetValue = arrowEl ? sideOffset + arrowEl.clientHeight : sideOffset
            const arrowWidth = arrowEl ? getHiddenElementWidth(arrowEl) : 0
                ...
                if (JSON.stringify({ x, y }) !== previousValue) {
                    ...
                    if (middlewareData.arrow) {
                        ...
                        Object.assign(arrowEl.style, {
                            left: x != null ? `${x + alignmentAdjustment}px` : '',
                            top: y != null ? `${y + alignmentAdjustment}px` : '',
